...
for EXEMPLARS_PER_CLASS in 30 50 #0 20 10 30 50
do
PYTHONPATH=$SRC_DIR python -u $SRC_DIR/main_incremental.py --exp_name cifar100_10tasks_lwf_new_ce_multihead \
       ...
       --approach lwf --gpu $1 --ce_exemplars_task_aware \
