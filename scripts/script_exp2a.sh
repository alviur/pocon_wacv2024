...
do
        if [ "$1" = "random5" ]; then
               ...
               do
                      PYTHONPATH=$SRC_DIR python3 -u $SRC_DIR/main_incremental.py --exp_name exp2a_random_${SEED} \
                             --datasets cifar100 --num_tasks 10 --network resnet32 --seed $SEED \
               ...
               PYTHONPATH=$SRC_DIR python3 -u $SRC_DIR/main_incremental.py --exp_name exp2a \
