...
do
PYTHONPATH=$SRC_DIR python -u $SRC_DIR/main_incremental.py --exp_name cifar100_10tasks_ce_additional_current_task \
       ...
       --approach lwf --gpu $1 --ce_additional_current_task \
