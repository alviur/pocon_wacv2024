...
for EXEMPLARS_PER_CLASS in 20 10 30 50
do

echo "APPROACH: $APPROACH with $EXEMPLARS_PER_CLASS exemplars/class..."

PYTHONPATH=$SRC_DIR python -u $SRC_DIR/main_incremental.py --exp_name run_with_exemplars \
       ...
       --approach eeil --gpu $1 --T 0 --lamb 0.0 \
