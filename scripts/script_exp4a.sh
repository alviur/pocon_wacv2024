...
if [ "$1" = "joint" ] || [ "$1" = "dmc" ]; then
        PYTHONPATH=$SRC_DIR python3 -u $SRC_DIR/main_incremental.py --exp_name exp4a \
               --datasets exp4_1-1 exp4_2-1 exp4_3-1 exp4_4-1 \
                          exp4_1-2 exp4_2-2 exp4_3-2 exp4_4-2 \
                          exp4_1-3 exp4_2-3 exp4_3-3 exp4_4-3 \
                          exp4_1-4 exp4_2-4 exp4_3-4 exp4_4-4 --num_tasks 1 --network alexnet \
