...
--network resnet18 --num_tasks 10 --seed 667 --batch_size 128 \
...
--kd_method EWC --approach simsiam --change_lr_scheduler --task1_nepochs 1500  \
--results_path $RESULT_DIR --lamb 90000 --loadTask1 --head_classifier_lr 5e-2
