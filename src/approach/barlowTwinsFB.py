...
class Appr(Learning_Appr):
    ...
    def extra_parser(args):
        ...
        parser.add_argument("--kd_method", default="ft", type=str, choices=['ft', 'L2', 'EWC', 'p2_f','EWC_p2','lwf_v3'])
    ...
    def train(self, t, trn_loader, val_loader):
        ...
        if t == 0:
            ...
            torch.distributed.init_process_group(backend='nccl', init_method='tcp://localhost:59217',
