...
class Appr(Learning_Appr):
    ...
    def __init__(
        ...
        self.skipTranfer = skipTranfer
        # self.dirichlet_sampling = num_samples * np.random.dirichlet(np.repeat(0.5, num_task), num_clases)
        # self.dirichlet_sampling = num_samples * np.random.dirichlet(np.repeat(0.5, num_task), num_clases)
    ...
    def extra_parser(args):
        ...
        parser.add_argument("--skipTranfer", type=int, default=1)
    ...
    def get_data_loaders(self, trn_loader, val_loader, t):  # -> Replace _prepare_transformations
        ...
        # # Dirichlet training here
        # if self.dirichlet:
        #     subset = trn_loader.dataset.splitInbalance(self.dirichlet_sampling[:,t])
    ...
    def train(self, t, trn_loader, val_loader,output_path):
        ...
        if t >= self.beginAtTask and t%self.skipTranfer == 0:
            ...
            print("--------No Adaptation phase-------", t, t%self.skipTranfer)
