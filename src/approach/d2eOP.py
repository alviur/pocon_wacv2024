...
class Appr(Learning_Appr):
    ...
    def train(self, t, trn_loader, val_loader,output_path):
        ...
        if t == 0:
            ...
            self.modelFB.projectorRet = utilsProj.prediction_mlp(512, 256, self.linearProjRet).to(self.device)
            #
            #
            if self.loadTask1:
        ...
        if t >= 0:
            ...
            self.modelFB.copyExpert.to(self.device)
            ...
            if t==0:
                adaRet_nepochs = 1*self.ret_nepochs
            else:
