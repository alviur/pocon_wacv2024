...
class Appr(Learning_Appr):
    ...
    def extra_parser(args):
        ...
        parser.add_argument("--kd_method", default="ft", type=str,
                            choices=['ft', 'L2', 'L2rel', 'L2relCos', 'p2', 'EWC'])
        ...
        parser.add_argument("--evalPath", default="", type=str)
    ...
    def eval(self, t, orig_val_loader, heads_to_evaluate=None):
        ...
        self.appendedResults.append(total_acc_taw / total_num)
        print(self.appendedResults)
