...
class Appr(Learning_Appr):
    ...
    def train(self, t, trn_loader, val_loader):
        ...
        if t == 0:
            ...
            path = '/home/agomezvi/simSiamLB2/modelsProj512/FT/' # FT
            #path = '/home/agomezvi/simSiamLB2/modelsProj512/EWC/'  # EWC
            #path = '/home/agomezvi/simSiamLB2/modelsProj512/P2/'  # P2
            #path = '/home/agomezvi/simSiamLB2/modelsProj512/P2_f/'  # P2_f
            #path = '/home/agomezvi/simSiamLB2/modelsProj512/FD/'  # FD
            #path = '/home/agomezvi/simSiamLB2/modelsProj512/single/'  # single
            #path = '/home/agomezvi/simSiamLB2/modelsProj512/joint/'  # Joint
            #path = '/home/agomezvi/simSiamLB2/tinyModels/'
            ## BT
            #path = '/home/agomezvi/simSiamLB2/result_simsiam/cifar100_noTrans_barlowTwinsFB_simsiam-11232021_115103_403249/'  # single
    ...
    def validateKNN(self, train_loader, val_loader, k=200, t=0.1, task = 1):
        modelT = deepcopy(self.modelFB.backbone).to(self.device)
        for param in modelT.parameters():
            param.requires_grad = False
        modelT.eval()
