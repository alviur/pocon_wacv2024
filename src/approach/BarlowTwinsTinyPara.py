...
class Appr(Learning_Appr):
    ...
    def train(self, t, trn_loader, val_loader):
        ...
        if t == 0:
            ...
            torch.distributed.init_process_group(backend='nccl', init_method='tcp://localhost:10045',
                                                 world_size=1, rank=0)
        ...
        if self.kd_method == "EWC":
            ...
            with override_dataset_transform(trn_loader.dataset, self.val_transformsEWC) as _ds_train:
                ...
                self.modelFB.post_train_process(t, trainloader)
        ...
        if(t>=0):
            ...
            save_checkpoint({
                'epoch': str(epochs),
                'arch': 'ResNet18',
                'simsiam': self.modelFB.state_dict(),
                'optimizer': self.optimizer.state_dict(),
            }, is_best=False, filename=path + 'model-task_' + str(
                t) + '.ckpt')
    ...
    def train_loop(self, t, trn_loader, val_loader, epoch):
        ...
        for i, ((x0, x1), _, _) in enumerate(self.dataloader_train_ssl):
            ...
            if t>0 and self.kd_method == "p2":
                ...
                z1, z2, f1Old, f2Old, f1, f2 = self.modelFB(x1=x0.to(self.device), x2=x1.to(self.device))
                ...
                z1, z2, fisher,older_params,backbone= self.modelFB(x1=x0.to(self.device), x2=x1.to(self.device))
                # empirical cross-correlation matrix
                c = self.modelFB.module.bn(z1).T @ self.modelFB.module.bn(z2)
                # sum the cross-correlation matrix between all gpus
                c.div_(z1.shape[0])
...
class BarlowTwins(nn.Module):
    ...
    def forward(self, x1, x2):
        ...
        if self.t > 0 and self.kd == 'L2':
            ...
            return z1, z2, f1Old, f2Old, f1, f2
        #
            ...
            return z1, z2, self.fisher, self.older_params, self.backbone
    ...
    def configure_optimizers(self):
        ...
        if self.t < 1:
            ...
            if self.kd == 'p2' or self.kd == 'p2_f' or self.kd == 'EWC_p2':
                ...
                params.append({'params': self.p2.parameters(), 'lr': 0.8 * 0.06})
