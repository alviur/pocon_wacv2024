...
from .mnist1d_models import LinearBase, MLPBase, ConvBase, GRUBase
...
allmodels = tvmodels + ['resnet32', 'LeNet', 'VggNet', 'LinearBase', 'MLPBase', 'ConvBase', 'GRUBase'] + \
    ['ss_resnet18', 'ss_resnet18_lightly', 'resnet18_and_proj']
