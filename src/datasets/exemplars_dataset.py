...
class ExemplarsDataset(MemoryDataset):
    ...
    def __init__(self, transform, class_indices,
                 num_exemplars=0, num_exemplars_per_class=20, exemplar_selection='random'):
    ...
    def extra_parser(args):
        ...
        parser.add_argument('--exemplar_selection', default='random', type=str, 
                            choices=['herding', 'random', 'entropy', 'distance', 'inventropy', 'invdistance'],
